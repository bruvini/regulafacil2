...
- Padrão de Commits: Todos os commits devem seguir o formato Conventional Commits e ser escritos EXCLUSIVAMENTE em Português do Brasil (ex: feat:, fix:, docs:, chore:).
